...
\begin{itemize}
	...
	\item Repeat the above experiment, now using your team's minimax agent from A1 as the opponent of your new AI agent.
	\item You are encouraged to include further experiments or expand the set of boards tested (e.g. different sizes and/or using non-empty starting positions). In this case, make sure you clearly explain the setup of your additional experiments.
